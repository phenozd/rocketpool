...
interface RocketMinipoolManagerInterface {
    ...
    function createVacantMinipool(address _nodeAddress, uint256 _salt, bytes calldata _validatorPubkey, uint256 _bondAmount) external returns (RocketMinipoolInterface);
