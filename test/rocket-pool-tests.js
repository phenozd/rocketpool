...
import supernodeDepositTests from './supernode/supernode-deposit-tests';
import supernodeBuyoutTests from './supernode/supernode-buyout-tests';
import supernodeDistributeTests from './supernode/supernode-distribute-tests';
...
rplTests();
rewardsPoolTests();
supernodeDepositTests();
supernodeBuyoutTests();
supernodeDistributeTests();
